<?php
	...
	$query = "SELECT idbarang, kode, tk.idkategori, namakategori, tj.idjenisbarang, namajenisbarang, td.iddetailbarang, namadetailbarang, 			     hargabarang, gambar, deskripsi, dilihat
			  FROM tbarang tb JOIN tkategori tk JOIN tjenisbarang tj JOIN tdetailbarang td
			  WHERE tb.idkategori = tk.idkategori AND tb.idkategori = '$idkategori' AND tj.idjenisbarang = '$idjenisbarang' AND tb.idjenisbarang = tj.idjenisbarang AND tb.iddetailbarang = td.iddetailbarang
